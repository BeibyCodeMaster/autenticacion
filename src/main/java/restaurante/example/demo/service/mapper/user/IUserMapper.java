...
public interface IUserMapper {
    ...
    @Mapping(source = "roleList", target = "user.roleList", qualifiedByName = "mapRoleEntitiesToNames")  // Lista de roles del usuario.
    ...
    @Mapping(source = "userName", target = "user.userName")
    @Mapping(source = "birthDate", target = "user.birthDate")
    @Mapping(source = "roleList", target = "user.roleList" , qualifiedByName = "mapRoleEntitiesToNames")
    @Mapping(source = "password", target = "user.password")
    @Mapping(source = "createdAt", target = "user.createdAt")
    @Mapping(source = "updatedAt", target = "user.updatedAt")
    ...
    @Mapping(source = "roleList", target = "roleList" , qualifiedByName = "mapRoleNamesToEntities")
