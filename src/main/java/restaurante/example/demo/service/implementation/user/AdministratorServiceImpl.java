...
public class AdministratorServiceImpl implements IAdministratorService {
    ...
    public AdministratorDto create(AdministratorDto entityDto) throws EntityDataAccesException {
        ...
        Set<RoleEntity>  rolesEntity =  entityDto.getUser().getRoleList().isEmpty()
                            ? Set.of( RoleEntity.builder()
                                .name(NameRoleEnum.Administrador.name())
                                .permissionList(Set.of(createPermission,redPermission,deletePermission))
                                .build())
                            : entityDto.getUser().getRoleList().stream()
                                .map(role -> RoleEntity.builder()
                                                .name(NameRoleEnum.valueOf(role).name())
                                .build())
        ...
        userEntity.setRoleList(rolesEntity); // El rol de ADMINISTRATOR se asigna al usuario
